...
```
docker run --platform linux/x86_64 --env JULIA_NUM_THREADS=4 -p 8888:8888 -v /path/on/your/machine:/notebooks haoyun/ccsenv:1.0
```
...
```
docker run --platform linux/x86_64 --env JULIA_NUM_THREADS=4 -p 8888:8888 -v /Users/haoyun/Desktop/testdocker:/notebooks haoyun/ccsenv:1.0
```
...
```
docker run -it haoyun/ccsenv:1.0 /bin/bash
```
