...
For a introduction to Julia [Julia](https://julialang.org/downloads/), check out this [tutorial](https://github.com/JuliaAcademy/Introduction-to-Julia).
...
```
docker run --platform linux/x86_64 --env JULIA_NUM_THREADS=4 -p 8888:8888 -v /path/on/your/machine:/notebooks haoyunl/eas-8803:4.0
```
...
Please turn in your assignments as pdf files. The assignments should be send to [Haoyun Li](mailto:hli853@gatech.edu). Late hand-ins are not accepted. If you have difficulty on the homework and want to ask for extension, please email Dr. Felix Herrmann and cc TA in advance (at least 2 days before the deadline).
