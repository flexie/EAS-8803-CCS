...
| [Storage of Carbon Dioxide in Saline Aquifers: Building confidence by forecasting and monitoring](https://library.seg.org/doi/abs/10.1190/1.9781560803959)[^4] | @ringrose2023storage | SEG, 2023 |
...
| [Reservoir model design : a practitioner's guide](https://galileo-gatech.primo.exlibrisgroup.com/discovery/fulldisplay?context=L&context=L&vid=01GALI_GIT:GT&vid=01GALI_GIT&docid=alma9914166889502947&tab=default_tab&lang=en)[^3] |@philip2015reservoir | Springer, 2015 |

[^1]: ebook available from the Georgia Tech Library

[^2]: ebook available from the Georgia Tech Library

[^3]: ebook available from the Georgia Tech Library

[^4]: available [here](https://www.dropbox.com/scl/fi/mmb27pcyzc4aga7dxceht/ringrose-2023-storage-of-carbon-dioxide-in-saline-aquifers-building-confidence-by-forecasting-and-monitoring.pdf?rlkey=pxnzmtxqloim835j1nq0js1og&st=buw4em7q&dl=0) for use during course only 
...
Seismic Monitoring CO~2~ Storage - EAS 4803 - EAS 8803 - FH is a cross-listed under/graduate course. The requirements differ as follows:
...
-   **April 30, 2:40-5:30 PM:** Final exam in L1116 Classroom ES&T
